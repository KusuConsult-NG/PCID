 ...
 * Sign in.
 *
 * The portal tells the caller nothing about why a sign-in failed beyond "those
 * details are not correct". A directory of who staffs which control room is a
 * useful thing to have if you are working out who to phish.
 */
