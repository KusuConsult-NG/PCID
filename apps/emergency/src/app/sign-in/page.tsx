      ...
      <main id="main">
        <div className="shell center-panel stack">
          ...
          <Notice title="Before you sign in">
            <p>
              A person&rsquo;s details open to you because you are attached to an active incident
              and you named it. Not because of your rank, and not because of your service.
            </p>
