 ...
 * exercised here for each of the officers the rest of the suite needs, because
 * it is also how they get sessions.
 *
...
const ROLES: readonly OfficerRole[] = [
...
for (const role of ROLES) {
  setup(
    ...
    async ({ page }) => {
      ...
      // A passphrase alone does not open a government account.
