      ...
      <main id="main">
        <div className="shell center-panel stack">
          ...
          <Notice title="Before you sign in">
            <p>
              Everything you open here is recorded against your name, with the reason you gave. The
              person whose record it is can see that entry, and nobody — including you — can alter
              or delete it afterwards.
            </p>
            <p style={{ marginBottom: 0 }}>
              Nobody from the platform team will ever ask you for your passphrase or for a code from
              your authenticator.
            </p>
          </Notice>
        </div>
