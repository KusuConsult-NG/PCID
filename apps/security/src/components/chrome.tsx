 ...
 *
 * A third colour, for the third audience. Somebody glancing at a screen in a
 * command room should be able to tell which of the three applications is open,
 * because they do very different things with the same register.
 */
export function Masthead({ children }: { children?: React.ReactNode }) {
  return (
    <header className="masthead masthead-security">
