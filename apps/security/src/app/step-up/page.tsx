    ...
    <>
      ...
      <main id="main">
        <div className="shell center-panel stack">
          ...
          <p>
            What you are about to do changes the register or somebody&rsquo;s access to it, so the
            platform wants the second factor again — not the one you gave this morning.
          </p>
